...
namespace DocumentationForWebApp2
{
    /// <summary>
    ...
    [HelpFileBuilderPlugInExport("DocumentationForWebApp2", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "DocumentationForWebApp2 plug-in")]
    public sealed class DocumentationForWebApp2PlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In DocumentationForWebApp2PlugIn Execute() method");
        }
        #endregion
